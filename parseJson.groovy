	      ...
	      steps { 
		   envInjectBuilder {
	         ...
	         ant {
                     ...
                     props('env_pass' : '"ssh_${environment}_password"' , 'ssh_service_pwd' : '"${!env_pass}"' , 'ssh_user' : 'docker' , 'repositoryName' : '$repositoryName' , 'subModuleName' : '$subModuleName' , 'env' : '$environment')
